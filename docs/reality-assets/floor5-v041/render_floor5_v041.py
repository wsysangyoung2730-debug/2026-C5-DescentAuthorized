...
OUT=Path(__file__).parent/'review_floor5_v041';OUT.mkdir(exist_ok=True)
SCENES={'F05A':'DA_F05A_MemoryOmissionResidue','F05B':'DA_F05B_OriginalMemoryAdministrator'}
queue=[('F05A','F05A_Overview',1),('F05A','F05A_iPad_MainCamera',1)]
...
print('Scheduled residue overview and combat-camera review')
