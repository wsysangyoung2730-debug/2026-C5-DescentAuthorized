...
OUT=Path(__file__).parent/'review_floor5_v040';OUT.mkdir(exist_ok=True)
SCENES={'F05A':'DA_F05A_MemoryOmissionResidue','F05B':'DA_F05B_OriginalMemoryAdministrator'}
queue=[(p,p+'_HeadTurn90_'+side,1) for p in SCENES for side in ['Left','Right']]
queue += [('F05A','F05A_Overview',1),('F05B','F05B_Overview',1),('F05A','F05A_iPad_MainCamera',1),('F05B','F05_iPad_MainCamera',1),('F05B','CAM_F05_RewardSelection',1),('F05B','CAM_F05_DescentDoor',1)]
